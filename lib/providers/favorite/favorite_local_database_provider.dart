...
class FavoriteLocalDatabaseProvider extends ChangeNotifier {
  final LocalDatabaseService _service;

  FavoriteLocalDatabaseProvider(this._service);
  ...
  Future<void> loadAllRestaurant() async {
    try {
      ...
      final result = await _service.getAllFavoriteRestaurants();
  ...
  Future<void> loadRestaurantById(String id) async {
    try {
      _restaurant = await _service.getFavoriteRestaurantById(id);
    } catch (e) {
